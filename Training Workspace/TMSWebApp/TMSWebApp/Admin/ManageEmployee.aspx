<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/tms.Master" AutoEventWireup="true" CodeBehind="ManageEmployee.aspx.cs" Inherits="TMSWebApp.Admin.ManageEmployee" %>
        ...
        <tr>
            <td>
                <div>
                    ...
                    <br/>
                    <br/>
                    <asp:GridView ID="GridView1" runat="server" CellPadding="6" ForeColor="#333333" GridLines="None" OnLoad="GridView1_Load"
                        BorderWidth="1px"  
