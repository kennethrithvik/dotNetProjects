<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Example7.aspx.cs" Inherits="CSS3Demos.Animation.Example7" %>
...
<body>
    <div id="wrapper">
            ...
            <h2><a href="" title="">onlinemovies.com</a></h2>
            <div id="content">
                <ul id="movieposters">
                    <li>
                        <img src="images/gallery/01_iron_man_2.jpg" alt="Iron Man 2" />
                        <div class="movieinfo">
                            <h3>Iron Man 2</h3>
                    ...
                    <li>
                        <img src="images/gallery/02_the_last_airbender.jpg" alt="The Last Airbender" />
                        <div class="movieinfo">
                    ...
                    <li>
                        <img src="images/gallery/03_tron_legacy.jpg" alt="Tron Legacy" />
                        <div class="movieinfo">
                            <h3>Tron Legacy</h3>
