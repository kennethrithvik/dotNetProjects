...
namespace HappyTrip.DataAccessLayer.Transaction
{
    ...
    interface IBookingDAOImpl
    {
        ...
        string MakeBooking(HappyTrip.Model.Entities.Transaction.Booking newBooking, IDbConnection dbConnection);

        //string MakeBooking(HappyTrip.Model.Entities.Transaction.Booking newBooking, Database dbConnection);
    }
}
