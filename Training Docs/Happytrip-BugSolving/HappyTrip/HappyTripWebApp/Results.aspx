<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Results.aspx.cs" MasterPageFile="~/Site.Master" Inherits="HappyTripWebApp.Results" %>
            ...
            <div id="ContentFrame" class="clearfix">
                ...
                <div id="ModifySearchWrapper">
                    ...
                    <div id="SearchParams">
                        <div id="SPRow">
                            ...
                            <ul class="inline">
                                <li class="no_border"><asp:Label ID="lblHeaderFromCity" runat="server"></asp:Label> – <asp:Label ID="lblHeaderToCity" runat="server"></asp:Label></li>
                                <li><asp:Label ID="lblHeaderDepart" runat="server"></asp:Label> <asp:Label ID="lblHeaderDateSeparator" runat="server" Visible="true"> - </asp:Label> <asp:Label ID="lblHeaderReturn" runat="server"></asp:Label>, <asp:Label runat="server" ID="lblAdults"></asp:Label> Seat</li>
                            </ul>
                            <div id="SalesUpsell">
                ...
                <div class="Right clearfix">
                    ...
                    <div class="col clearfix">
                        ...
                        <div id="SelectionInfo" class="clearfix">
                            ...
                            <div id="dynamic_price" class="dynamic_price">
                                <!--[if IE]>
										...
										<![endif]-->
                                <span id="total_price" style="background-image: none; background-color: rgb(255, 255, 255);"></span>                       <br style="line-height: 0px; clear: both;">
                            ...
                            <div id="CurrentSelection" class="clearfix deal">
                                ...
                                <div id="selectedflights">
                                    <div id="selectedreturn" class="flight clearfix">
                                        ...
                                        <h3>
                                            <span id="resultreturnflightname"></span></h3>
                                        <span id="resultreturnflightcode"></span><br/>
                                        <span id="resultreturndate"></span><br>
                                        <span class="departs" id="resultreturndepart"></span> – <span class="arrives" id="resultreturnarrive"></span><br>
                                    ...
                                    <div id="selectedoutbound" class="flight clearfix">
                                        ...
                                        <h3>
                                            <span id="resultonwardflightname"></span></h3>
                                        <span id="resultonwardflightcode"></span><br/>
                                        <span id="resultonwarddate"></span><br>
                                        <span class="departs" id="resultonwarddepart"></span> – <span class="arrives" id="resultonwardarrive"></span><br>
                        ...
                        <!-- Begin : Message to be displayed while there is an error -->
                        <div id="error_message">
                            <asp:Label ID="lblError" runat="server" Visible="False" ForeColor="Red"></asp:Label>
                        </div>
                        <!-- End : Message to be displayed while there is an error -->
                        ...
                        <div id="universalDiv" class="universal">
                            ...
                            <div class="sector" id="outbound_div" runat="server">
                                <div id="sector_info_heading" class="sector_info">
                                    <h2>
                                        <asp:Label ID="lblOneWayFromCity" runat="server"></asp:Label> to <asp:Label ID="lblOneWayToCity" runat="server"></asp:Label></h2>
                                </div>
                                <div id="outbound">
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <div>
                                                        <span id="depart"><%# (new DateTime(((HappyTrip.Model.Entities.AirTravel.Schedule)Container.DataItem).DepartureTime.Ticks).ToString("HH:mm")) %></span></div>
                                                </td>
                                                <td>
                                                    <div>
                                                        <span id="arrive"><%# (new DateTime(((HappyTrip.Model.Entities.AirTravel.Schedule)Container.DataItem).ArrivalTime.Ticks).ToString("HH:mm")) %></span></div>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="noborder weak"></td>
                                            </tr>
                                            <tr>
                                                <td class="noborder weak"></td><td class="noborder weak"></td>
                                                <td colspan="4" class="noborder weak">
                                                    <!--Airline Name With Flight Name to be displayed here-->
                                                    <span id="flightname"><%# ((HappyTrip.Model.Entities.AirTravel.Schedule)Container.DataItem).FlightInfo.AirlineForFlight.Name%></span> : <span id="flightcode"><%# ((HappyTrip.Model.Entities.AirTravel.Schedule)Container.DataItem).FlightInfo.AirlineForFlight.Code%></span>
                                                </td>
                                            </tr>
                                            <tr>
                            ...
                            <div class="sector" id="return_div" runat="server">
                                <div class="sector_info">
                                    <h2>
                                        <asp:Label ID="lblReturnFromCity" runat="server"></asp:Label> to <asp:Label ID="lblReturnToCity" runat="server"></asp:Label>
                                    </h2>
                                </div>
                                <div id="return">
                                    <table id="tblreturn">
