<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="Index.aspx.cs" Inherits="HappyTripWebApp.Index" %>
...
<script type="text/javascript">
    ...
    $(function () {
        $("#MainContent_origin_autocomplete").autocomplete({
            ...
            focus: function (event, ui) { $("#MainContent_origin_autocomplete").val(ui.item.label); },
        ...
        $("#MainContent_destination_autocomplete").autocomplete({
            ...
            focus: function (event, ui) { $("#MainContent_destination_autocomplete").val(ui.item.label); },
            ...
            <div id="ContentFrame" class="clearfix">
                ...
                <div class="Left">
                    <div class="col">
                        ...
                        errorblockid="flt_err" action="flight_booking.html">
                        <fieldset class="search_type">
                            <table>
                                <tbody>
                                    <tr>
                                        <td>
                                            <label for="one_way" class="encaps">
                                                <asp:RadioButton ID="one_way" runat="server" GroupName="rnd_one"/>
                                                <strong>One way</strong></label>
                                        </td>
                                        <td>
                                            <label for="multi_city" class="encaps">
                                    ...
                                    <tr>
                                        <td id="tdDepart">
                                            ...
                                            <span class="enclosedPicker">
                                                <asp:TextBox ID="dpt_date" CssClass="datePicker required" Rows="10" name="depart_date" ToolTip="Departure date" runat="server"></asp:TextBox>
                                            </span>
                                        </td>
                                        <td id="tdReturn">
                                            ...
                                            <span class="enclosedPicker" style="">
                                                <asp:TextBox ID="rtn_date" CssClass="datePicker second required no_autochange" maxdate="7/1/2014" mindatefieldid="dpt_date" selflabel="dd/mm/yyyy" Rows="10" name="return_date" ToolTip="Return date" runat="server"></asp:TextBox>
                                            </span>
                                        </td>
                                    </tr>
                                </tbody>
                        ...
                        <fieldset class="submit">
                            <table>
                                <tbody>
                                    <tr>
                                        <td>
                                            <asp:Button ID="button_flight_search" ToolTip="search" CssClass="booking" 
                                                runat="server" Text="Search flights" onclick="button_flight_search_Click" />
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
